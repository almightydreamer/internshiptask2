...
class TextStyles {
  ...
  static TextStyle taskValue = TextStyle(fontFamily: Fonts.poppinsRegular, fontSize: 14, fontWeight: FontWeight.w400);
  static TextStyle taskTitle = TextStyle(fontFamily: Fonts.poppinsRegular, fontSize: 16, color: CustomColor.goalTitle, fontWeight: FontWeight.w600);
